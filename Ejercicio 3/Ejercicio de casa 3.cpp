...
void display(void)   // Creamos la funcion donde se dibuja
{
	...
	glPushMatrix(); //Panza
	glTranslatef(1.0f, -0.5, 0);
	glScalef(8.0f, 5.0f, 3.0f);
	prisma();
	glPopMatrix();

	glPushMatrix(); //Panza
	glTranslatef(1.5, 3.5, 0);
	glScalef(7.0f, 3.0f, 3.0f);
	prisma();
	glPopMatrix();

	glPushMatrix(); //Cabeza
	glTranslatef(-4.5, 4.5, 0);
	glScalef(5.0f, 5.0f, 3.0f);
	prisma();
	glPopMatrix();

	glPushMatrix(); //Trompa
	glTranslatef(-6.0f, -0.5, 1.0f);
	glScalef(2.0f, 5.0f, 1.0f);
	prisma();
	glPopMatrix();

	glPushMatrix(); //Pata izquierda
	glTranslatef(-2.0f, -5.5, 1.0f);
	glScalef(2.0f, 5.0f, 1.0f);
	prisma();
	glPopMatrix();

	glPushMatrix(); //Pata derecha
	glTranslatef(4.0f, -5.5, 1.0f);
	glScalef(2.0f, 5.0f, 1.0f);
	prisma();
	glPopMatrix();
	...
	glPushMatrix(); //Cola
	glTranslatef(7.0f, 0.5, 0.0f);
	glScalef(4.0f, 1.0f, 1.0f);
	prisma();
	glPopMatrix();

	glPushMatrix(); //Cola otra
	glTranslatef(8.5, -0.5, 0.0f);
	prisma();
	glPopMatrix();
