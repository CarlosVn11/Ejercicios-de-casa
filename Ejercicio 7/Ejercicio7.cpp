...
//*************	 Visual Studio 2017					          ******//
//*************  Ejercicio de casa 7: Mesa de ajedrez con silla ***//
//*************  Fecha: 15/10/2018                              **//
//***************************************************************//
#include "texture.h"
...
void display(void)   // Creamos la funcion donde se dibuja
{
	...
	renderBitmapCharacter(-11, 12.0, -14.0, (void *)font, "Ejercicio de casa 7");
	renderBitmapCharacter(-11, 10.5, -14, (void *)font, "Mesa de ajedrez con silla");
	glEnable(GL_TEXTURE_2D);
